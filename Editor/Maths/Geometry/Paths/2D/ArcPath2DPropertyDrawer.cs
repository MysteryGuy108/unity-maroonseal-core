...
{
    [CustomPropertyDrawer(typeof(ArcPath2D))]
    public class ArcPath2DPropertyDrawer : PathBasePropertyDrawer
    {
        public override VisualElement CreatePropertyGUI(SerializedProperty _property)
        {
            ...
            root.Add(new PropertyField(arcProperty.FindPropertyRelative("<Transform>k__BackingField")));
