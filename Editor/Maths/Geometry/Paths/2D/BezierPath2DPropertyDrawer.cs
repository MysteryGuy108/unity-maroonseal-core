...
{
    [CustomPropertyDrawer(typeof(BezierPath2D))]
    public class BezierPath2DPropertyDrawer : PathBasePropertyDrawer
    {
        public override VisualElement CreatePropertyGUI(SerializedProperty _property)
        {
            ...
            root.Add(new PropertyField(_property.FindPropertyRelative("resolution")));
            return root;
        }
    }
}