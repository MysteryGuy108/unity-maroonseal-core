...
namespace MaroonSealEditor.Maths.Geometry.Paths {
    ...
    sealed public class SplinePointPropertyDrawer : PropertyDrawer
    {
        ...
        public override VisualElement CreatePropertyGUI(SerializedProperty _property) {
            ...
            anchorField.AddToClassList(BaseField<Vector3>.alignedFieldUssClassName);
            foldout.Add(anchorField);

            // Roll Field
            PropertyField rollField = new(_property.FindPropertyRelative("roll"));
            rollField.AddToClassList(BaseField<float>.alignedFieldUssClassName);
            foldout.Add(rollField);

            // Size Field
            PropertyField sizeField = new(_property.FindPropertyRelative("size"));
            sizeField.AddToClassList(BaseField<Vector2>.alignedFieldUssClassName);
            ...
            tangentInField.AddToClassList(BaseField<Vector3>.alignedFieldUssClassName);
            ...
            tangentOutField.AddToClassList(BaseField<Vector3>.alignedFieldUssClassName);
