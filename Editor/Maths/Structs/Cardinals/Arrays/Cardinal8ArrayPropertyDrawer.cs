...
{
    [CustomPropertyDrawer(typeof(Cardinal8Array<>))]
    public class Cardinal8ArrayPropertyDrawer : PropertyDrawer
    {
        public static string[] cardinalDisplayNames = new string[8] { "N", "NE", "E", "SE", "S", "SW", "W", "NW" };
