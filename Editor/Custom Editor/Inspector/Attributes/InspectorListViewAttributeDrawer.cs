...
{
    [CustomPropertyDrawer(typeof(InspectorListViewAttribute))]
    public class InspectorListViewAttributeDrawer : PropertyDrawer
    {
        public override VisualElement CreatePropertyGUI(SerializedProperty _property) {
            
            PropertyField root = new(_property);
            
            InspectorListViewAttribute fixedCollectionAttribute = attribute as InspectorListViewAttribute;
