...
namespace MaroonSeal.Maths.Geometry.Paths {
    ...
    public struct VehiclePoint {
        ...
        public static explicit operator Transform2D(VehiclePoint _vehicle) =>
    ...
    public class VehiclePath : PointPath<VehiclePoint, ReedsSheppPath>
    {
        ...
        {
            Transform2D startPoint = new(_start.position, _start.bearing);

            ReedsSheppPath bestPath = ReedsSheppPath.FindShortestPath(startPoint, (Transform2D)_end, _start.minRadius, _start.gearChangeWeight);
