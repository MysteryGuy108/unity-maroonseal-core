...
namespace MaroonSeal.Maths.Geometry.Shapes {
    ...
    public struct Triangle : IShape3D, IPolygon, ISDFShape
    {
        ...
        #region Triangle
        readonly public bool ContainsPoint(Vector3 _point) { return _point == p1 || _point == p2 || _point == p3; }
        ...
        readonly public Line GetEdgeAB() { return new Line(p1, p2); }
        readonly public Line GetEdgeBC() { return new Line(p2, p3); }
        readonly public Line GetEdgeCA() { return new Line(p3, p1); }
