...
namespace MaroonSeal.Maths.Geometry {
    [System.Serializable]
    public struct Box2D : IBox<Vector2, Transform2D>, IPolygon<Vector2, Transform2D, Line2D>, IEquatable<Box2D>
    {
        ...
        #region Constructors
        public Box2D(Transform2D _transform, Vector2 _dimensions) {
        ...
        #region IEquatable
        readonly public bool Equals(Box2D _other) => this.Transform == _other.Transform && this.dimensions == _other.dimensions;
        public override readonly bool Equals(object obj) => obj != null && obj is Box2D && ((Box2D)obj).Equals(this);
