...
namespace MaroonSeal.Maths.Geometry
{
    ...
    public struct Hexagon2DGridGeometry : IGridGeometry2D
    {
        ...
        public IShape<Vector2, Transform2D> GetCellShape(Vector2Int _cell)
        {
            return new Hexagon2D(new Transform2D(GetCellCentre(_cell), 90.0f), CellRadius);
        }

        public TShape2D GetCellShape<TShape2D>(Vector2Int _cell) where TShape2D : IShape<Vector2, Transform2D> {
