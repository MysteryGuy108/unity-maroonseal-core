...
namespace MaroonSeal.Maths.Geometry.Paths.ReedsShepp {
    internal class ReedsSheppPathFinder
    {
        ...
        static public List<ReedsSheppPath> GetAllPaths(Transform2D _start, Transform2D _end, float _minRadius = 1.0f)
        {
            List<ReedsSheppPath> pathCases = new();

            Transform2D target = ChangeOfBasis(_start, _end, _minRadius);
        ...
        static public List<ReedsSheppPath> GetDubinsPaths(Transform2D _start, Transform2D _end, float _minRadius = 1.0f)
        {
            List<ReedsSheppPath> pathCases = new();
        ...
        static public List<ReedsSheppPath> GetReverseDubinsPaths(Transform2D _start, Transform2D _end, float _minRadius = 1.0f)
        {
            List<ReedsSheppPath> pathCases = new();
        ...
        static private Transform2D ChangeOfBasis(Transform2D _base, Transform2D _current, float _minRadius)
        {
